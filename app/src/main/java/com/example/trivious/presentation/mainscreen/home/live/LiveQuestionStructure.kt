            ...
            Row(modifier = Modifier.padding(start = 8.dp, end = 8.dp, bottom = 8.dp)) {
                ...
                Button(
                    onClick = {
                        ...
                        Log.d("Contest Value", "LiveSingleQuestionItem:Clicked ")
                    },
                    Modifier
                        .weight(1f)
                        .height(50.dp), colors = ButtonDefaults.buttonColors(
                ...
                LivePaymentDialog(viewModel = viewModel, navController = navController)
...
@Preview
@Composable
fun LiveSingleItemPreview() {
    TriviousTheme {
        LiveSingleQuestionItem(title = "Live", index = 1, viewModel = LiveViewModel(), navController = rememberNavController())
    }
