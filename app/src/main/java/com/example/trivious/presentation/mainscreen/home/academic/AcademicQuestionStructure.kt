...
@Composable
fun AcademicSingleQuestionItem(modifier: Modifier = Modifier, title: String, index: Int) {
    Surface(
        modifier = modifier
...
@Preview
@Composable
fun AcademicSingleItemPreview() {
    TriviousTheme() {
        AcademicSingleQuestionItem(title = "Academic", index = 1)
    }
