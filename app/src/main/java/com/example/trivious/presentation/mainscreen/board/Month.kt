    ...
    Column(
        ...
        LazyColumn() {
            items(quizorder) { index ->
                Spacer(modifier = Modifier.height(12.dp))
                MonthFullLeaderBoard(
                    index = quizorder.indexOf(index)+4,
                    name = index.name ,
                    amount = index.amount * 9 ,
                )
                Spacer(modifier = Modifier.height(12.dp))
            }
...
@Preview
@Composable
fun MonthLeaderBoardPreview() {
    TriviousTheme() {
        MonthFullLeaderBoard(4,"@James Godwill",100)
    }

}
@Preview
@Composable
fun MonthTopThreePreview() {
    TriviousTheme() {
        MonthTopThree()
    }
